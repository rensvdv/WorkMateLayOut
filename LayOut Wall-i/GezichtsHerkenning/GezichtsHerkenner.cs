...
namespace LayOut_Wall_i
{
    class GezichtsHerkenner
    {
        ...
        public static async Task DetectFaceExtractURL(IFaceClient client, string url, string recognitionModel)
        {
        ...
        public static async Task<bool> VergelijkGroep(IFaceClient faceClient, string persionPicPath, String[] picsPath, string naam)
        {
            ...
            string groupname = "c" + rnd.Next(1, 900000).ToString();
                ...
                using (Stream s = File.OpenRead(pic))
                {
                    ...
                    foreach (var identifyResult in results)
                    {
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Gezichten komen overeen");//, person.Name);
                            verificatie = true;
                        }
                    }
